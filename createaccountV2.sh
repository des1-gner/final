...
# Total number of errors found: X these found errors are accompanied by a comment that goes into detail about the gategory, description and solution for the code.
